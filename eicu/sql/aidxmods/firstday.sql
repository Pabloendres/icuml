...
select
    ...
    concat('02-', charttimes.patientunitstayid) as idi,
    -- 'MIMIC-III' as center,
    -- 'UCI' as unit,
    ...
    labs.fio2_min as fio2_min,
    labs.fio2_avg as fio2_avg,
    labs.fio2_max as fio2_max,
    ...
    labs.bnp_min as bnp_min,
    labs.bnp_avg as bnp_avg,
    labs.bnp_max as bnp_max,
    labs.fibrinogen_min as fibrinogen_min,
    labs.fibrinogen_avg as fibrinogen_avg,
    labs.fibrinogen_max as fibrinogen_max,
...
left join admissions
    on admissions.patienthealthsystemstayid = charttimes.patienthealthsystemstayid

left join diagnoses
    on diagnoses.patienthealthsystemstayid = charttimes.patienthealthsystemstayid
    
left join heightweights
    on heightweights.patientunitstayid = charttimes.patientunitstayid
    and heightweights.los = charttimes.los

left join vitals
    on vitals.patientunitstayid = charttimes.patientunitstayid
    and vitals.los = charttimes.los
    
left join labs
    on labs.patientunitstayid = charttimes.patientunitstayid
    and labs.los = charttimes.los
    
left join gcs
    on gcs.patientunitstayid = charttimes.patientunitstayid
    and gcs.los = charttimes.los
    
left join inputs
    on inputs.patientunitstayid = charttimes.patientunitstayid
    and inputs.los = charttimes.los
    
left join outputs
    on outputs.patientunitstayid = charttimes.patientunitstayid
    and outputs.los = charttimes.los

order by charttimes.uniquepid, charttimes.patienthealthsystemstayid, charttimes.patientunitstayid, charttimes.los
